...
export class SellerService {
  ...
  public getStats(content_oid: string, start: number, size: number): Observable<{}> {
    const url = `${URL}/a/v2/seller/stats?content_oid=${content_oid}&start=${start}&size=${size}`;
